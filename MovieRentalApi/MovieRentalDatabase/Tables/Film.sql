...
(
	...
	[RentalDuration] INT NOT NULL CONSTRAINT DF_Film_RentalDuration DEFAULT (3),
	[RentalPrice] DECIMAL(4,2) NOT NULL CONSTRAINT DF_Film_RentalPrice DEFAULT (4.99),
	[Length] INT NULL,
	[ReplacementCost] DECIMAL(5,2) NOT NULL CONSTRAINT DF_Film_ReplacementCost DEFAULT (19.99),
	[RatingId] INT NOT NULL CONSTRAINT DF_Film_RatingId DEFAULT (1),
