...
(
	...
	CONSTRAINT [FK_RentalDetail_Rental] FOREIGN KEY ([RentalId]) REFERENCES [Rental]([RentalId]),
	CONSTRAINT [FK_RentalDetail_Film] FOREIGN KEY ([FilmId]) REFERENCES [Film] ([FilmId])
)
GO
